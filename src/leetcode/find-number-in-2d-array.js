 ...
 */
 var findNumberIn2DArray = function(matrix, target) {
    ...
    // opt1
    let rowIndex = rowLen, colIndex = colLen
    while(true) {
        if(!matrix[rowIndex]){
            return false
        }
...
console.log(findNumberIn2DArray([[5,6,10,14],[6,10,13,18],[10,13,18,19]], 14))
console.log(findNumberIn2DArray([[3,3,8,13,13,18],[4,5,11,13,18,20],[9,9,14,15,23,23],[13,18,22,22,25,27],[18,22,23,28,30,33],[21,25,28,30,35,35],[24,25,33,36,37,40]], 21))